...
from fastapi.middleware.cors import CORSMiddleware # CORS es un mecanismo del navegador, que permite o bloquea peticiones hechas desde un 
                                                # dominio a otro, dependiendo de como este tenga CORS configurado
...
app.add_middleware( # Mediante la configuracion del middleware CORS, controlamos que origenes oueden hacer que peticiones y con que parametros 
    CORSMiddleware,
    ...
    allow_methods=["GET","POST","PUT","DELETE"], # Declaramos los metodos HTTP permitidos  
    allow_headers = ["Authorization","Content-Type"], # Define las cabeceras permitidas que puede enviar el cliente
