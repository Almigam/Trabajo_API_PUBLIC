...
def create_access_token(data: dict, expires_delta: Optional[timedelta] = None) -> str:
    ...
    # Agrega el campo "exp" (expiration) al diccionario.
    to_encode.update({"exp": expire})

    # jwt.encode: Crea el string codificado usando la CLAVE SECRETA y el algoritmo.
...
def decode_token(token: str) -> Dict:
    ...
    try:
        ...
        # Error específico: El tiempo 'exp' ya pasó.
        ...
        # Cualquier otro error (token mal formado, firma falsa, etc).
